...
da = DeepAgent(
    # "return teh next number in the sequence 1,2,3,4,5, ",
    "Could MAGA be considered a cult a personality around Trump similar to North Korea. Output your report as markdown.",
    # "Give me a detailed report on the history of the internet, including key milestones, influential figures, and its impact on society. The report should be well-structured with sections for each aspect of the topic, and include citations for all sources used in text and at the end.",
    ...
    # "Research what Turboquant is for me. I need a detailed report along with clear and simple explanations of what it is, how it works, and how to implement. Be sure to give me clear citations as well. Your final output should be in markdown.",
    model="gpt-5.1",
    trace=True,
)
...
with open("output_2.json", "w") as json_file:
    json.dump(result.model_dump_json(), json_file, indent=4)

with open("turboquant.md", "w") as f:
