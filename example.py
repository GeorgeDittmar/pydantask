...
da = DeepAgent(
    ...
    # "Research what Turboquant is for me. I need a detailed report along with clear and simple explanations of what it is, how it works, and how to implement. Be sure to give me clear citations as well."
    model="gpt-5.1",
    trace=True,
)
